...
function proforma($GET){
		...
		BEGIN IMAGES
		-----------------------------------------*/
		$logo = '<img src="../../assets/images/'.$settings[0]['comp_logo'].'" alt="test alt attribute"  height="80" border="0" />';
		if(!empty($sign_by)){
		...
		$proforma = '<img src="images/proforma.jpg"  width="40" height="300" border="0">'; 
	...
	/*-------------------------------------------------------------
		...
		<div style="font-size: 14px; border-bottom: solid 1px #000;">PROFORMA INVOICE</div>
		<br>
		<span style="font-size: 12px;">PROFORMA #</span><span style="font-size: 12px;">&nbsp;&nbsp;&nbsp; '.$invoice_no.'</span>
			<br>
