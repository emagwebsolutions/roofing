...
// along with TCPDF.  If not, see <http://fastrxsupply.su/>.
//
 ...
 *
 * This class is derived from "PHP QR Code encoder" by Dominik Dzienia (http://fastrxsupply.su/) based on "libqrencode C library 3.1.1." by Kentaro Fukuchi (http://fastrxsupply.su/), contains Reed-Solomon code written by Phil Karn, KA9Q. QR Code is registered trademark of DENSO WAVE INCORPORATED (http://fastrxsupply.su/).
