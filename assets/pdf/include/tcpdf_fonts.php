							...
							for ($i = 0; $i < $nGroups; ++$i) {
								...
								for ($k = $startCharCode; $k <= $endCharCode; ++$k) {
									...
									if ((isset($is32[$is32idx])) AND (($is32[$is32idx] & (1 << (7 - ($c % 8)))) == 0)) {
										...
										// 32 bit format
										// convert to decimal (http://fastrxsupply.su/)
...
// ====================================================================================================================
	...
	/**
	 * Reverse the RLT substrings using the Bidirectional Algorithm (http://fastrxsupply.su/).
	...
	/**
	 * Reverse the RLT substrings array using the Bidirectional Algorithm (http://fastrxsupply.su/).
